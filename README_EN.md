...
There are many personal information in the template that need to be configured by yourself. Please be patient to modify it. You can refer to the blogger's website building tutorial:[ https://soosim.github.io/posts/blog/ ]( https://soosim.github.io/posts/blog/ )
...
link: {{< link src="www.sulvblog.cn" desc="https://soosim.github.ioo" >}}
```
...
{{< gallery >}}
{{< figure src="https://soosim.github.io/posts/read/structural_thinking/0.png" >}}
{{< figure src="https://soosim.github.io/posts/read/structural_thinking/0.png" >}}
{{< /gallery >}}
```
